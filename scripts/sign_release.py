...
class ReleaseSigner:
    ...
    def _sign_with_key(self, file_path: str) -> str:
        ...
        cmd = [
            "cosign", "sign-blob",
            "--key", self.key_path,
            "--output-signature", f"{file_path}.sig",
            file_path
        ]
    ...
    def generate_provenance(
        ...
        provenance = {
            ...
            "predicate": {
                ...
                "runDetails": {
                    "builder": {
                        "id": "https://agentos.dev/builder@v1",
                        "version": {
                            "agent-os": "1.0.0"
                        }
                    },
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Sign releases and generate SLSA provenance (open source tools)'
    )
    ...
    sign_parser.add_argument(
        '--key',
        help='Path to Cosign private key (optional for keyless)'
    )
