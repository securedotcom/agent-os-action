...
def sample_findings():
    ...
    return [
        ...
        FindingComparison(
            ...
            score_difference=0.1,
            agreed=True,
            agent_os_verdict="definitely_false_positive",
...
class TestDatabaseInitialization:
    ...
    def test_table_schema(self, monitor, temp_db):
        ...
        expected_columns = {
            ...
            "agent_os_findings_count", "codex_findings_count",
            "agreed_findings_count", "agent_os_only_count",
