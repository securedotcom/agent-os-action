...
class TestRegression:
    ...
    def test_json_output_format_unchanged(self):
        ...
        required_fields = [
            'version', 'timestamp', 'repository', 'commit',
            'files_reviewed', 'lines_analyzed', 'tokens_input',
            'tokens_output', 'cost_usd', 'duration_seconds',
            'findings', 'categories'
        ]
...
class TestDataStructureCompatibility:
    ...
    def test_metrics_structure_compatible(self):
        ...
        original_fields = [
            ...
            'files_reviewed', 'lines_analyzed', 'tokens_input',
            'tokens_output', 'cost_usd', 'duration_seconds',
            'model', 'provider', 'findings', 'categories'
        ]
    ...
    def test_config_structure_compatible(self):
        ...
        original_options = [
            'ai_provider', 'max_files', 'max_tokens',
            'cost_limit', 'max_file_size'
        ]
