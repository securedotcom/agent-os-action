Check `argus/specs/[this-spec]/tasks.md` and ensure that all tasks and their sub-tasks are marked as completed with `- [x]`.
...
- Check for existence of an implementation report titled using this task's title in `argus/spec/[this-spec]/implementation/` folder.
