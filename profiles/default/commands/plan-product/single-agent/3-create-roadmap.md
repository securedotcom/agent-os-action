Now that you've created this product's mission.md, use that to guide your creation of the roadmap in `argus/product/roadmap.md` by following these instructions:
...
```
✅ I have documented the product roadmap at `argus/product/roadmap.md`.
