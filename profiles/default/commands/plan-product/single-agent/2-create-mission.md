Now that you've gathered information about this product, use that info to create the mission document in `argus/product/mission.md` by following these instructions:
...
```
✅ I have documented the product mission at `argus/product/mission.md`.
